    ...
    >
      ...
      <div className="relative max-w-5xl px-6 md:px-12 text-center md:text-left">
        <motion.p
          ...
          whileInView="show"
          viewport={{ once: true }}
          className="text-emerald-400 font-semibold tracking-wide uppercase mb-4"
        >
          Marketing Agency
        </motion.p>
        ...
        >
          ...
          <Button
            variant="outline"
            className="border-white text-black hover:bg-white hover:text-emerald-500 px-8 py-4 rounded-full text-lg transition-all"
          >
            How We Work →
          </Button>
        </motion.div>
