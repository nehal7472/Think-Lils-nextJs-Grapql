    ...
    <section className="relative">
      <div className="grid grid-cols-1 md:grid-cols-5">
        ...
        <div className="bg-emerald-400/95 md:col-span-3 flex flex-col justify-center px-6 py-10 md:px-16">
          ...
          {/* CTA Button */}
          <Link href="/contact">
            <div className="group px-8 py-4 bg-black text-white font-semibold rounded-xl flex items-center gap-3 w-fit hover:bg-white hover:text-black border border-black transition-all duration-300 ">
              Let’s Work Together
